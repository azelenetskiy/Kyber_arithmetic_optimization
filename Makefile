...
CFLAGS += -Wall -Wextra -Wpedantic -Wmissing-prototypes -Wredundant-decls \
  -Wshadow -Wpointer-arith -O3 -fomit-frame-pointer -I/opt/homebrew/opt/openssl/include
NISTFLAGS += -Wno-unused-result -O3 -fomit-frame-pointer
RM = /bin/rm
LDFLAGS= -L/opt/homebrew/opt/openssl/lib

SOURCES = kex.c kem.c indcpa.c polyvec.c poly.c arithmetic.c cbd.c verify.c
SOURCESKECCAK = $(SOURCES) fips202.c symmetric-shake.c
SOURCESNINETIES = $(SOURCES) sha256.c sha512.c aes256ctr.c symmetric-aes.c
HEADERS = params.h kex.h kem.h indcpa.h polyvec.h poly.h arithmetic.h cbd.h verify.h symmetric.h
